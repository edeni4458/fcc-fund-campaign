    ...
    return (
        <div className='sectionIII_main-container'>
            <div className='fund_video-container'>
                ...
                <iframe id='fund-video' src="https://www.youtube-nocookie.com/embed/bL3mashs3Do?si=-VXqq4FXzg7huSme" title="FCC Building Vision Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>                <p>“That big old building sitting there is how you project the gospel forward in your city.”<br /><span id='itally-Mark'>Mark Dever, Pastor, Capitol Hill Baptist Church</span></p>
            </div>
